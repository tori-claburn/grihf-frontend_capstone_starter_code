...
exports.resolveLineTagLocations = exports.defaultAdapter = exports.debugServerPort = exports.gdbPath = exports.isRemoteTest = exports.openGdbConsole = exports.standardBeforeEach = exports.testProgramsDir = exports.compareVariable = exports.verifyVariable = exports.expectRejection = exports.getScopes = void 0;
...
function standardBeforeEach(adapter) {
    return __awaiter(this, void 0, void 0, function* () {
        const dc = new debugClient_1.CdtDebugClient('node', getAdapterAndArgs(adapter), 'cdt-amalgamator', {
            shell: true,
        });
