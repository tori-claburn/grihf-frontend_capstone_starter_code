...
describe('terminated', function () {
    ...
    it('terminated event arrives after continuing after a breakpoint', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all([
                ...
                dc.continueRequest({ threadId: (yield (0, utils_1.getScopes)(dc)).thread.id }),
            ]);
        });
    });
    it('terminated event arrives on a short run', function () {
        return __awaiter(this, void 0, void 0, function* () {
            yield Promise.all([
                dc.waitForEvent('terminated'),
                dc
                ...
                dc.launch((0, utils_1.fillDefaults)(this.test, {
                    program: emptyProgram,
                })),
            ]);
        });
...
//# sourceMappingURL=terminated.spec.js.map