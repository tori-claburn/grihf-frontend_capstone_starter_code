...
module.exports = (async () => {
    ...
    try {
        ...
        await load(container, require('@theia/plugin-metrics/lib/browser/plugin-metrics-frontend-module'));
        ...
        await load(container, require('skills-network-extension/lib/browser/skills-network-frontend-module'));
        await load(container, require('blueprint-product-ext/lib/browser/theia-blueprint-frontend-module'));
