...
module.exports = async (port, host, argv) => {
    try {
        ...
        await load(require('skills-network-extension/lib/node/my-service.module'));
        await load(require('blueprint-product-ext/lib/node/theia-blueprint-backend-module'));
